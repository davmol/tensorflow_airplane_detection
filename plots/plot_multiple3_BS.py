...
nine_hours_from_now = datetime.datetime.strptime('2020-01-09', '%Y-%m-%d') + datetime.timedelta(hours=4)
...
def subplots(data):
    ...
    fig, ax = plt.subplots(len(data), 7, figsize=(45, 15))
    ...
    for num, values in enumerate(data):
        ...
        ax[num, 0].set_xlim(datetimes[0] + datetime.timedelta(hours=4), datetimes[0] + datetime.timedelta(hours=16))
        ...
        ax[num, 1].set_xlim(datetimes[1] + datetime.timedelta(hours=4), datetimes[1] + datetime.timedelta(hours=16))
        ...
        ax[num, 2].set_xlim(datetimes[2] + datetime.timedelta(hours=4), datetimes[2] + datetime.timedelta(hours=16))
        ...
        ax[num, 3].set_xlim(datetimes[3] + datetime.timedelta(hours=4), datetimes[3] + datetime.timedelta(hours=16))
        ...
        ax[num, 4].set_xlim(datetimes[4] + datetime.timedelta(hours=4), datetimes[4] + datetime.timedelta(hours=16))
        ...
        ax[num, 5].set_xlim(datetimes[5] + datetime.timedelta(hours=4), datetimes[5] + datetime.timedelta(hours=16))
        ...
        ax[num, 6].set_xlim(datetimes[6] + datetime.timedelta(hours=4), datetimes[6] + datetime.timedelta(hours=16))
